...
class AlipayServiceProvider extends ServiceProvider
{
	...
	public function register()
	{
		...
		$this->app->bind('alipay.mobile', function ($app)
		{
			...
			$alipay->setPartner($app->config->get('alipay.latrell-alipay.partner_id'))
				->setSellerId($app->config->get('alipay.latrell-alipay.seller_id'))
				->setSignType($app->config->get('alipay.latrell-alipay-mobile.sign_type'))
				->setPrivateKeyPath($app->config->get('alipay.latrell-alipay-mobile.private_key_path'))
				->setPublicKeyPath($app->config->get('alipay.latrell-alipay-mobile.public_key_path'))
				->setNotifyUrl($app->config->get('alipay.latrell-alipay-mobile.notify_url'));
		...
		$this->app->bind('alipay.web', function ($app)
		{
			...
			$alipay->setPartner($app->config->get('alipay.latrell-alipay.partner_id'))
				->setSellerId($app->config->get('alipay.latrell-alipay.seller_id'))
				->setKey($app->config->get('alipay.latrell-alipay-web.key'))
				->setSignType($app->config->get('alipay.latrell-alipay-web.sign_type'))
				->setNotifyUrl($app->config->get('alipay.latrell-alipay-web.notify_url'))
				->setReturnUrl($app->config->get('alipay.latrell-alipay-web.return_url'))
